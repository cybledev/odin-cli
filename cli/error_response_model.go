...
func registerModelErrorResponseFlags(depth int, cmdPrefix string, cmd *cobra.Command) error {
	...
	if err := registerErrorResponsePropSuccess(depth, cmdPrefix, cmd); err != nil {
		return err
	}
...
func registerErrorResponsePropSuccess(depth int, cmdPrefix string, cmd *cobra.Command) error {
	if depth > maxDepth {
		return nil
	}
...
func retrieveModelErrorResponseFlags(depth int, m *models.ErrorResponse, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	...
	err, SuccessAdded := retrieveErrorResponsePropSuccessFlags(depth, m, cmdPrefix, cmd)
	if err != nil {
		return err, false
	}
...
func retrieveErrorResponsePropSuccessFlags(depth int, m *models.ErrorResponse, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	if depth > maxDepth {
		return nil, false
	}
	retAdded := false
