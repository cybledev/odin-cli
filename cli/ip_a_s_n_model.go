...
// Schema cli for IPASN

// register flags to command
func registerModelIPASNFlags(depth int, cmdPrefix string, cmd *cobra.Command) error {

	if err := registerIPASNPropCountryCode(depth, cmdPrefix, cmd); err != nil {
		return err
	}

	if err := registerIPASNPropNumber(depth, cmdPrefix, cmd); err != nil {
		return err
	}

	if err := registerIPASNPropOrganization(depth, cmdPrefix, cmd); err != nil {
		return err
	}
...
func registerIPASNPropCountryCode(depth int, cmdPrefix string, cmd *cobra.Command) error {
	if depth > maxDepth {
		return nil
	}
...
func registerIPASNPropNumber(depth int, cmdPrefix string, cmd *cobra.Command) error {
	if depth > maxDepth {
		return nil
	}
...
func registerIPASNPropOrganization(depth int, cmdPrefix string, cmd *cobra.Command) error {
	if depth > maxDepth {
		return nil
	}
...
func retrieveModelIPASNFlags(depth int, m *models.IPASN, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	retAdded := false

	err, CountryCodeAdded := retrieveIPASNPropCountryCodeFlags(depth, m, cmdPrefix, cmd)
	if err != nil {
		return err, false
	}
	retAdded = retAdded || CountryCodeAdded

	err, NumberAdded := retrieveIPASNPropNumberFlags(depth, m, cmdPrefix, cmd)
	if err != nil {
		return err, false
	}
	retAdded = retAdded || NumberAdded

	err, OrganizationAdded := retrieveIPASNPropOrganizationFlags(depth, m, cmdPrefix, cmd)
	if err != nil {
		return err, false
	}
...
func retrieveIPASNPropCountryCodeFlags(depth int, m *models.IPASN, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	if depth > maxDepth {
		return nil, false
	}
	retAdded := false
...
func retrieveIPASNPropNumberFlags(depth int, m *models.IPASN, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	if depth > maxDepth {
		return nil, false
	}
	retAdded := false
...
func retrieveIPASNPropOrganizationFlags(depth int, m *models.IPASN, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	if depth > maxDepth {
		return nil, false
	}
	retAdded := false
